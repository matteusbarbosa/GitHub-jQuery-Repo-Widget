;jQuery(document).ready(function($){
	...
	$('.github-widget').each(function(){
		...
		$widget = $(
			...
			+'<a class="watchers" href="' + repoUrl + '/watchers" title="Visualizar watchers">?</a>'
			+'<a class="forks" href="' + repoUrl + '/network/members" title="Visualizar forkers">?</a>'
			+'</div>'
			+'</div>'
			+'<div class="github-box-content">'
			+'<p class="description"><span></span> &mdash; <a href="' + repoUrl + '#readme">Visualizar no Github</a></p>'
			+'<p class="link"></p>'
			+'</div>'
			+'<div class="github-box-download">'
			+'<div class="updated"></div>'
			+'<a class="download" href="' + repoUrl + '/zipball/master" title="Obter uma cópia desse repositório">Baixar .zip</a>'
			+'</div>'
			+'</div>'
		);
		...
		$.ajax({
			...
			success: function(results) {
				var repo = results.data, date, pushed_at = 'desconhecido';
